...
function M.setup(config)
  ...
  theme.base = {
    ...
    Folded       = { fg = c.folded , bg = c.fg_gutter },                             -- line used for closed folds
    ...
    Substitute   = { bg = c.substitute, fg = c.black },                              -- |:substitute| replacement text highlighting
    LineNr       = { fg = c.fg_gutter },                                             -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    CursorLineNr = { fg = c.cursorlinenr },                                          -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    MatchParen   = { fg = c.matchparen, style = "bold" },                            -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ModeMsg      = { fg = c.fg_dark, style = "bold" },                               -- 'showmode' message (e.g., "-- INSERT -- ")
    MsgArea      = { fg = c.fg_dark },                                               -- Area for messages and cmdline

    -- MsgSeparator= { }, -- Separator for scrolled messages, `msgsep` flag of 'display'

    MoreMsg      = { fg = c.moremsg },                                        -- |more-prompt|
    ...
    Question     = { fg = c.question },                                       -- |hit-enter| prompt and yes/no questions
    ...
    IncSearch    = { bg = c.search, fg = c.black },                           -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
    SpecialKey   = { fg = c.specialkey },                                     -- Unprintable characters: text displayed differently from what it really is.  But not 'listchars' whitespace. |hl-Whitespace|
    ...
    Title        = { fg = c.title, style = "bold" },                          -- titles for output from ":set all", ":autocmd" etc.
    ...
    Identifier = { fg = c.identifier, style = config.variableStyle }, -- (preferred) any variable name
    Function   = { fg = c.func, style = config.functionStyle },       -- function name (also: methods for classes)
    ...
    Keyword  = { fg = c.keyword, style = config.keywordStyle }, -- any other keyword
    ...
    Special = { fg = c.lue1 }, -- (preferred) any special symbol
  ...
  theme.plugins = {
    ...
    TSConstructor = { fg = c.tsconstructor }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
    ...
    TSField = { fg = c.tsfield }, -- For fields.
    ...
    TSKeyword         = { fg = c.tskeyword, style = config.keywordStyle },          -- For keywords that don't fall in previous categories.
    TSKeywordFunction = { fg = c.tskeywordfunction, style = config.functionStyle }, -- For keywords used to define a fuction.
    TSLabel           = { fg = c.tslabel },                                         -- For labels: `label:` in C and `:label:` in Lua.
    ...
    TSOperator  = { fg = c.tsoperator }, -- For any operator: `+`, but also `->` and `*` in C.
    TSParameter = { fg = c.tsparameter}, -- For parameters of a function.

    -- TSParameterReference= { };    -- For references to parameters of a function.

    TSProperty       = { fg = c.tsproperty},        -- Same as `TSField`.
    TSPunctDelimiter = { fg = c.tspunctdelimiter }, -- For delimiters ie: `.`
    TSPunctBracket   = { fg = c.tspunctbracket },   -- For brackets and parens.
    TSPunctSpecial   = { fg = c.tspunctspecial },   -- For special punctutation that does not fall in the catagories before.

    -- TSRepeat            = { };    -- For keywords related to loops.
    -- TSString            = { };    -- For strings.

    TSStringRegex = { fg = c.tsstringregex },   -- For regexes.
    TSStringEscape = { fg = c.tsstringescape }, -- For escape characters within a string.
    ...
    TSVariableBuiltin = { fg = c.tsvariablebuiltin }, -- Variable names that are defined by the languages, like `this` or `self`.

    -- TSTag               = { };    -- Tags like html tag names.
    -- TSTagDelimiter      = { };    -- Tag delimiter like `<` `>` `/`
    -- TSText              = { };    -- For strings considered text in a markup language.

    TSTextReference = { fg = c.tstextreference }, -- FIXME
    --
